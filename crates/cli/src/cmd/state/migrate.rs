// crates/cli/src/cmd/state/migrate.rs — `loadout state migrate` implementation
//
// The top-level `loadout migrate` alias delegates here with a deprecation
// warning. This module contains the single source of truth.
